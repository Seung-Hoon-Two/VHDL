...
HD_PWD='C:/Users/s.hoon/Desktop/ASCII_5x7_font/ASCII_5x7_font.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASCII_5x7_font.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ASCII_5x7_font.tcl -notrace
