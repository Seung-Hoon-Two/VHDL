...
HD_PWD='C:/Users/s.hoon/Desktop/ASCII_5x7_font/ASCII_5x7_font.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASCII_5x7_font.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASCII_5x7_font.tcl
