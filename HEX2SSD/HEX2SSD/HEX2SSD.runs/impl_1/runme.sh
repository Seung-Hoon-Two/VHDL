...
HD_PWD='C:/Users/s.hoon/Desktop/HEX2SSD/HEX2SSD/HEX2SSD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HEX2SSD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HEX2SSD.tcl -notrace
