...
HD_PWD='C:/Users/s.hoon/Desktop/dot_matrix/dot_matrix.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dot_matrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dot_matrix.tcl
