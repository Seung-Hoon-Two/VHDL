...
HD_PWD='C:/Users/s.hoon/Desktop/dot_matrix/dot_matrix.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dot_matrix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dot_matrix.tcl -notrace
