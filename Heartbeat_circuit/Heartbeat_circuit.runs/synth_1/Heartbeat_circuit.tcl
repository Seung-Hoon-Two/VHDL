...
synth_design -top Heartbeat_circuit -part xc7s25csga225-1
...
write_checkpoint -force -noxdef Heartbeat_circuit.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Heartbeat_circuit_utilization_synth.rpt -pb Heartbeat_circuit_utilization_synth.pb"
