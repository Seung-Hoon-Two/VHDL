...
HD_PWD='C:/Users/s.hoon/Desktop/Heartbeat_circuit/Heartbeat_circuit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Heartbeat_circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Heartbeat_circuit.tcl -notrace
